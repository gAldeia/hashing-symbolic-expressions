# Modified by: Guilherme Aldeia <guilherme.aldeia@ufabc.edu.br> 11/05/23
...
def graph_ranks(avranks, names, p_values, cd=None, cdmethod=None, lowv=None, highv=None,
                width=6, textspace=1, reverse=False, filename=None, labels=True, **kwargs):
    """
...
def draw_cd_diagram(df_perf=None, alpha=0.05, title=None, labels=True, path=None):
    """
    Draws the critical difference diagram given the list of pairwise classifiers that are
    significant or not
    """
    res = wilcoxon_holm(df_perf=df_perf, alpha=alpha)

    if res is None:
        return 
    
    # unpacking statistics, if exist
    p_values, average_ranks, _ = res
